...
5. Apply new "upstream" to original `nvnamsss/grule-rule-engine` git 
...
5. Create PullRequest. 
    * Go to `hithub.com/nvnamsss/grule-ruleengine`
    * Select `Pull Request` tab
    * Click "New pull request" button
    * Click "compare across fork"
    * Change the source head repository from your fork and target is `nvnamsss/grule-rule-engine`
